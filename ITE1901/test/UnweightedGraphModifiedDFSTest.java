...
public class UnweightedGraphModifiedDFSTest {
  public static void main(String[] args) {
    ...
    Graph<String> graph = new UnweightedGraphModifiedDFS<>(vertices, edges);
    UnweightedGraphModifiedDFS<String>.SearchTree dfs = graph.dfs(graph.getIndex("Chicago"));

    List<Integer> searchOrder = dfs.getSearchOrder();
    System.out.println(dfs.getNumberOfVerticesFound() + " vertices are searched in this DFS order:");

    for (Integer order : searchOrder) {
      System.out.print(graph.getVertex(order) + " ");
    }
