...
//Når Image-objektets .src settes startes nedlasting. Når nedlastinga er ferdig kalles image.onload().
...
function shadersLocationURL() {
	...
	var completePath = document.location.protocol + "//" + document.location.host + path + "shaders/";
	return completePath;
};
