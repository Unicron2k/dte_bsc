...
let rbStick;
let boardRotAngle = Math.PI/16;      // Dersom planet skal roteres.
...
export function createTerrain(scene){
	...
	textureLoader.load( "./images/tile2.png", function( texture ) {
		...
		// Kollisjonsfiltrering: Denne RB tilhører gruppa Plane og skal kunne kollidere med objekter i gruppene Box OG Sphere.
...
export function createBall(scene, radius, pos, color, mass){
	...
	// Kollisjonsfiltrering: Denne RB tilhører gruppa Sphere og skal kunne kollidere med objekter i gruppene Plane OG Box.
...
export function createBox(scene, pos, color, mass, boxSize) {
	...
	// Kollisjonsfiltrering: Denne RB tilhører gruppa Box og skal kunne kollidere med objekter i gruppene Plane OG Sphere.
	physicsWorld.addRigidBody(rbGreenBox, colGroupBox, colGroupBall | colGroupPlane | colGroupStick);
