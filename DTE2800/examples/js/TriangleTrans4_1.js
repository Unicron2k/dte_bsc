...
function drawCoord() {
	...
	mvpMatrix.set(projectionMatrix).multiply(modelviewMatrix); // NB! rekkefølge!
...
function drawTriangle() {
	...
	//gl.drawArrays(gl.LINE_LOOP, 0, vertexBufferTriangle.numberOfItems);
}
...
function setupCamera() {
	...
	//viewMatrix.setLookAt(4, 6, 15, 0, 0, 0, 0, 1, 0);
	viewMatrix.setLookAt(40, 25, 100, 0, 0, 0, 0, 1, 0);
...
function draw() {
	...
	//modelMatrix.translate(4, 2, -3);
	//modelMatrix.scale(0.5, 0.5, 0.5);

	//rgba = [ 0.8, 0.3, 1.0, 1.0 ];
	rgba = [ 0.0, 0.5, 0.7, 1.0 ];
	drawTriangle();
}
