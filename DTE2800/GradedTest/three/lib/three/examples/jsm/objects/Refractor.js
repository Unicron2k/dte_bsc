...
var Refractor = function ( geometry, options ) {
	...
	// This will update the textures matrix that is used for projective textures mapping in the shader.
	...
	function updateTextureMatrix( camera ) {
		...
		// we use "Object Linear Texgen", so we need to multiply the textures matrix T
