...
GLTFExporter.prototype = {
	...
	parse: function ( input, onDone, options ) {
		...
		/**
		 * Applies a textures transform, if present, to the map definition. Requires
		 ...
		 * @return {Integer}     Index of the processed textures in the "images" array
		 */
		 ...
		 * @return {Integer}     Index of the processed textures in the "samplers" array
		 */
		 ...
		 * @return {Integer}     Index of the processed textures in the "textures" array
		 */
