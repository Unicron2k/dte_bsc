...
var VolumeSlice = function ( volume, index, axis ) {
	...
	/**
	 * @member {HTMLCanvasElement} canvas The final canvas used for the textures
	 */
	/**
...
VolumeSlice.prototype = {
	...
	/**
	 * @member {Function} repaint Refresh the textures and the geometry if geometryNeedsUpdate is set to true
