/**
 * @author miibond
 * Generate a textures that represents the luminosity of the current scene, adapted over time
...
AdaptiveToneMappingPass.prototype = Object.assign( Object.create( Pass.prototype ), {
	...
	reset: function () {
		...
		//Put something in the adaptive luminance textures so that the scene can render initially
