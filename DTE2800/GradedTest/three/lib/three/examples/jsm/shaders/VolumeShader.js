...
var VolumeRenderShader1 = {
	...
	fragmentShader: [
				...
				'void main() {',
						...
						// Get starting location and step vector in textures coordinates
				...
				'float sample1(vec3 texcoords) {',
						'/* Sample float value from a 3D textures. Assumes intensity data. */',
						'return textures(u_data, texcoords.xyz).r;',
				'}',
