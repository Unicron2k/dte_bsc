...
var GLTFLoader = ( function () {
	...
	function GLTFTextureDDSExtension( ddsLoader ) {
		...
		if ( ! ddsLoader ) {
			...
			throw new Error( 'THREE.GLTFLoader: Attempting to load .dds textures without importing DDSLoader' );
		...
		return {
			...
			extendParams: function ( materialParams, materialDef, parser ) {
				...
				var specularMapFragmentChunk = [
					...
					'	// reads channel RGB, compatible with a glTF Specular-Glossiness (RGBA) textures',
				...
				var glossinessMapFragmentChunk = [
					...
					'	// reads channel A, compatible with a glTF Specular-Glossiness (RGBA) textures',
			...
			refreshUniforms: function ( renderer, scene, camera, geometry, material ) {
				...
				if ( material.envMap ) {
					...
					//  WebGLRenderTargetCube.textures will be flipped because it's a Texture and NOT a CubeTexture
	...
	/**
	 * Asynchronously assigns a textures to the given material parameters.
