...
var FBXLoader = ( function () {
	...
	FBXTreeParser.prototype = {
		...
		// Parses FBXTree.Connections which holds parent-child connections between objects (e.g. material -> textures, model->geometry )
		...
		// load a textures specified as a blob or data URI, or via an external URL using TextureLoader
		loadTexture: function ( textureNode, images ) {
			...
			if ( extension === 'tga' ) {
				...
				if ( loader === null ) {
					...
					console.warn( 'FBXLoader: TGA loader not found, creating placeholder textures for', textureNode.RelativeFilename );
					texture = new Texture();
				...
				console.warn( 'FBXLoader: PSD textures are not supported, creating placeholder textures for', textureNode.RelativeFilename );
				texture = new Texture();
		...
		// Materials are connected to textures maps in FBXTree.Objects.Textures
		...
		// Also parse the textures map and return any textures associated with the material
		parseParameters: function ( materialNode, textureMap, ID ) {
			...
			connections.get( ID ).children.forEach( function ( child ) {
				...
				switch ( type ) {
					...
					default:
						console.warn( 'THREE.FBXLoader: %s map is not supported in three.js, skipping textures.', type );
						break;
		...
		// get a textures from the textureMap for use by a material.
		getTexture: function ( textureMap, id ) {

			// if the textures is a layered textures, just use the first layer and issue a warning
