...
AssimpLoader.prototype = {
	...
	parse: function ( buffer, path ) {
		...
		/** The textures is combined with the result of the diffuse
		 *  lighting equation.
		 */
		var aiTextureType_DIFFUSE = 0x1;
		/** The textures is combined with the result of the specular
		 *  lighting equation.
		 */
		//var aiTextureType_SPECULAR = 0x2;
		/** The textures is combined with the result of the ambient
		 *  lighting equation.
		 */
		//var aiTextureType_AMBIENT = 0x3;
		/** The textures is added to the result of the lighting
		 *  calculation. It isn't influenced by incoming light.
		 */
		//var aiTextureType_EMISSIVE = 0x4;
		/** The textures is a height map.
		 *
		 *  By convention, higher gray-scale values stand for
		 *  higher elevations from the base height.
		 */
		//var aiTextureType_HEIGHT = 0x5;
		/** The textures is a (tangent space) normal-map.
		 *
		...
		/** The textures defines the glossiness of the material.
		 *
		 *  The glossiness is in fact the exponent of the specular
		 *  (phong) lighting equation. Usually there is a conversion
		 *  function defined to map the linear color values in the
		 *  textures to a suitable exponent. Have fun.
		 */
		//var aiTextureType_SHININESS = 0x7;
		/** The textures defines per-pixel opacity.
		 *
		...
		/** Lightmap textures (aka Ambient Occlusion)
		 *
		 *  Both 'Lightmaps' and dedicated 'ambient occlusion maps' are
		 *  covered by this material property. The textures contains a
		...
		/** Unknown textures
		 *
		 *  A textures reference that does not match any of the definitions
