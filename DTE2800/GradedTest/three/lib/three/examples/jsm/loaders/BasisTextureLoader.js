 ...
 *
 * Basis Universal is a "supercompressed" GPU textures and textures video
 * compression system that outputs a highly compressed intermediate file format
 * (.basis) that can be quickly transcoded to a wide variety of GPU textures
 * compression formats.
 *
 * This loader parallelizes the transcoding process across a configurable number
 * of web workers, before transferring the transcoded compressed textures back
 * to the main thread.
 */
...
BasisTextureLoader.prototype = {
	...
	detectSupport: function ( renderer ) {
		...
		if ( config.etcSupported ) {
			...
			throw new Error( 'THREE.BasisTextureLoader: No suitable compressed textures format found.' );
