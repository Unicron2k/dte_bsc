	...
	parse: function ( text, path ) {
		...
		function buildMaterial( data ) {
			...
			function getTexture( textureObject ) {
				...
				// create textures if image is avaiable
				...
				if ( image !== null ) {
					...
					if ( loader !== undefined ) {
						...
						console.warn( 'THREE.ColladaLoader: Loader for textures %s not found.', image );
					...
					console.warn( 'THREE.ColladaLoader: Couldn\'t create textures with ID:', textureObject.id );
			...
			if ( transparent && transparency ) {
				...
				// handle case if a textures exists but no color
