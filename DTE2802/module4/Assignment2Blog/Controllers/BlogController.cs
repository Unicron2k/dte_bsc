...
using Assignment2Blog.Authorization;
...
namespace Assignment2Blog.Controllers
{
    public class BlogController : Controller
    {
        ...
        public BlogController(ILogger<BlogController> logger, UserManager<IdentityUser> userManager, IBlogPostRepository repository, IAuthorizationService authorizationService = null)
        {
            _logger = logger;
