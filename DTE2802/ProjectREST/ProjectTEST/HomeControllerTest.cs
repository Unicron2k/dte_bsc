...
namespace ProjectTEST
{
    ...
    public class UnitTest1
    {
        ...
        public void SetupContext() {
            ...
            {
                new Blog {BlogId = 1, Name = "test1", Description = "test1", Owner = new ApplicationUser(), CreationDate = "2020-10-04", BlogLocked = false},
                new Blog {BlogId = 2, Name = "test2", Description = "test2", Owner = new ApplicationUser(), CreationDate = "2020-10-04", BlogLocked = false},
                new Blog {BlogId = 3, Name = "test3", Description = "test3", Owner = new ApplicationUser(), CreationDate = "2020-10-04", BlogLocked = false},
            };
        }
