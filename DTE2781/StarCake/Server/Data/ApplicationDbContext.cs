        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<ApplicationUser>().HasData(
                ...
                new ApplicationUser
                {
                    ...
                    LockoutEnabled = true,
                    LockoutEnd = null,
                    NormalizedEmail = "FGFG@UIT.COM;",
                    NormalizedUserName = "FGFG@UIT.COM",
                    PasswordHash = hasher.HashPassword(null, "ferrari123"),
                    PhoneNumber = "97637348", 
                    PhoneNumberConfirmed = false,
                ...
                new ApplicationUser
                {
                    ...
                    LockoutEnabled = true,
                    LockoutEnd = null,
                    NormalizedEmail = "AND@UIT.NO",
                    NormalizedUserName = "AND@UIT.NO",
                    PasswordHash = hasher.HashPassword(null, "Qwerty1!"),
                    PhoneNumber = "48484848", 
                    PhoneNumberConfirmed = false,
                ...
                new ApplicationUser
                {
                    ...
                    LockoutEnabled = true,
                    LockoutEnd = null,
                    NormalizedEmail = "MAIL@UIT.NO",
                    NormalizedUserName = "MAIL@UIT.NO",
                    PasswordHash = hasher.HashPassword(null, "Qwerty1!"),
                    PhoneNumber = "48484848", 
                    PhoneNumberConfirmed = false,
                    SecurityStamp = "44Q4G5DMLMBFO3EKYP2OS2A3LWWNUQKX",
                    TwoFactorEnabled = false,
                    UserName = "mail@uit.no",
                    CreationDate = DateTime.Now,
                    FirstName = "Me",
                    LastName = "Me",
                    CurrentLoggedInDepartmentId = 3,
